    ...
    public class TaskPool
    {
        ...
        private class InternalTaskHolder : IInternalTask
        {
            ...
            public async Task Execute()
            {
                ...
                {
                    FormManager.GetMainForm().Log("Ошибка исполнения метода TaskPool - " + ex.Message);
                }
            }
        }
        ...
        /// <summary>
        /// Dispose all running tasks (added by artybyte)
        /// </summary>
        public void Dispose()
        {
            foreach (IInternalTask task in workingTasks)
                ((Task)task).Dispose();
        }
